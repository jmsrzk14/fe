...
export default function HimpunanEditPage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(`${API_URL}/admin/department/${id}`, {
  ...
  const handleBack = () => router.push("/admin/department");
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        const ts = Date.now();
        router.push(`/admin/department?page=1&updated=${ts}`);
      }
    } catch (err) {
