...
const AspirationPage: React.FC = () => {
  ...
  // ✅ perbaikan di sini
  const handleAdd = () => {
    router.push("/bem/aspirasi/create");
  };
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-3">
            {statusLoading ? (
              ...
              <>
                <span
                  className={`font-medium ${status === 1 ? "text-green-600" : "text-red-600"}`}
                >
                  {status === 1 ? "Aspirasi Aktif" : "Aspirasi Nonaktif"}
                </span>
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-green-400 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-500"></div>
                </label>
              </>
            ) : (
              <span className="text-sm text-gray-400">Status tidak tersedia</span>
            )}
