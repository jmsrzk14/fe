...
const TableContainer: React.FC = () => {
  ...
  const fetchOrganizations = async () => {
    ...
    try {
      // Fetch Himpunan
      const himpunanResponse = await fetch("https://be-jmsrzk147707-ttmyeqw8.apn.leapcell.online/api/association", {
        method: "GET",
        headers: {
    ...
    // Fetch UKM
    try {
      const ukmResponse = await fetch("https://be-jmsrzk147707-ttmyeqw8.apn.leapcell.online/api/club", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
    ...
    // Fetch Department
    try {
      const departmentResponse = await fetch("https://be-jmsrzk147707-ttmyeqw8.apn.leapcell.online/api/department", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const fetchData = async (pageNumber: number) => {
    ...
    try {
      ...
      let res = await fetch(
        `https://be-jmsrzk147707-ttmyeqw8.apn.leapcell.online/api/admin/students?${params.toString()}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  const assignRole = async (studentId: number, role: string, category: string, period: string, organizationId?: number, organizationShortname?: string, positionTitle?: string) => {
    ...
    try {
      ...
      const response = await fetch(`https://be-jmsrzk147707-ttmyeqw8.apn.leapcell.online/api/admin/students/${studentId}/assign`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
