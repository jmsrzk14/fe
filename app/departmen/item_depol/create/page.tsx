...
export default function MahasiswaCreatePage() {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {      
      ...
      formDataToSend.append("amount", formData.jumlah);
      if (formData.gambar instanceof File) {
        formDataToSend.append("image", formData.gambar);
      }

      const response = await axios.post(
        `${API_URL}/student/item_depol`,
        formDataToSend,
        {
          headers: {
      ...
      if (response.status === 201 || response.status === 200) {
          AlertToast.success("Data Barang berhasil ditambahkan.");
        router.push("/departmen/item_depol");
        return;
      }
    } catch (err) {
  ...
  const handleBack = () => {
    router.push("/student/item_depol");
  };
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          >
            ...
            />
            <span className="font-medium">Kembali ke Data Barang</span>
          </button>
            ...
            <div className="bg-blue-50 border-2 border-blue-200 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-blue-700">Nama Barang</span>
                  <CheckCircle2
                    size={16}
                    className={
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-blue-700">Kuantitas</span>
                  <CheckCircle2
                    size={16}
                    className={
                      formData.jumlah ? "text-green-500" : "text-blue-300"
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-blue-700">Foto Barang</span>
                  <CheckCircle2
                    size={16}
                    className={
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-blue-700 space-y-1">
                    <li>🎯 Gunakan nama yang lengkap</li>
