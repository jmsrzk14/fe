  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!username) {
      Swal.fire({
        icon: "error",
        title: "Belum Login",
        text: "Silakan login terlebih dahulu sebelum mengajukan peminjaman.",
        confirmButtonColor: "#2563eb",
      });
    ...
    try {
      ...
      if (res.ok) {
        // Tutup loading dan tampilkan toast sukses
        Swal.fire({
          toast: true,
          position: "top-end",
          icon: "success",
        ...
        setTimeout(() => {
          router.push("/departmen/request_sarpras");
        }, 1800);
      } else {
        Swal.fire({
          icon: "error",
