...
const NewsPage: React.FC = () => {
  ...
  const handleEdit = (item: any) => {
    ...
    if (typeof item === "number") {
      ...
      if (!resolvedId) {
        console.warn(
          "handleEdit: index provided but no row at that index",
          item
        );
      }
    } else if (item && typeof item === "object") {
    ...
    router.push(`/departmen/news/edit?id=${encodeURIComponent(resolvedId)}`);
  };
                ...
                <div className="flex justify-center">
                  <div className="relative group">
                    ...
                    <div className="relative w-64 h-64 bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
                      {selectedNews.image ? (
                        <NextImage
                          src={`${IMAGE_URL}/${selectedNews.image}`}
                ...
                <div className="space-y-6">
                  ...
                  <div className="group">
                    ...
                    <div className="bg-gradient-to-r from-purple-50 to-rose-50 p-5 rounded-2xl border-2 border-purple-100 group-hover:border-purple-300 transition-all">
                      <p className="text-base font-medium text-gray-800 whitespace-pre-wrap">
                        {selectedNews.content
                          ? selectedNews.content.replace(/<[^>]*>/g, "")
                          : "—"}
                      </p>
                    </div>
                  </div>
