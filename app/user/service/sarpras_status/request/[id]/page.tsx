...
const RequestDetailPage: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await fetch(
        `${API_URL}/student/request_sarpras/image_barang/${id}`,
        {
          method: "PUT",
          headers: { Authorization: `Bearer ${token}` },
          body: formData,
  ...
  const handleReturn = async () => {
    ...
    try {
      const res = await fetch(
        `${API_URL}/student/request_sarpras/return/${id}`,
        {
          method: "PUT",
          headers: {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 min-h-screen py-[15vh]">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-4">Detail Peminjaman Barang SARPRAS</h1>
