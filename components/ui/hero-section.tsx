...
export default function HeroSection() {
  const carouselImages = [
    ...
    '/logo/Logo_DPDK.png',
    '/logo/Logo_DIPTEK.png',
    '/logo/Logo_DEPSENBUD.png',
    '/logo/Logo_DPHM.png',
  ];
    ...
    <section className="relative text-black overflow-hidden min-h-screen flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Left: Text Content and Carousel (Desktop) */}
          <div className="text-center lg:text-left space-y-6">
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="inline-block mt-8 lg:mt-0 px-4 py-2 bg-blue-700 text-white rounded-full shadow-md text-sm font-semibold tracking-wide">
                WELCOME TO
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight text-blue-800">
                BEM IT DEL <span className="text-black">{currentYear}</span>
              </h1>
            ...
            <div className="mt-10 relative overflow-hidden lg:block hidden">
              <motion.div
          ...
          {/* Right: Logo and Carousel (Mobile) */}
          <motion.div
          ...
          >
            ...
            <div className="relative overflow-hidden w-full block lg:hidden">
              <motion.div
                className="flex gap-4 sm:gap-6"
                animate={{ x: ['0%', '-100%'] }}
                transition={{
